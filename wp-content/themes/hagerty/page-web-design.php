...
// HERO SECTION
// ACF Fields:
// - webdesign_hero_label (WYSIWYG)
// - webdesign_hero_heading_line_1 (WYSIWYG)
// - webdesign_hero_heading_line_2 (WYSIWYG)
// - webdesign_hero_description (WYSIWYG)
// - webdesign_hero_background_type (Select: none, image, video)
// - webdesign_hero_background_image (Image)
// - webdesign_hero_background_video_mp4 (File)
// - webdesign_hero_background_video_webm (File)
// - webdesign_hero_background_video_poster (Image)
// - webdesign_hero_background_overlay_opacity (Number)
// - webdesign_hero_primary_button (Link)
// - webdesign_hero_secondary_button (Link)
// ============================================
$hero_label = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_hero_label') : '', 'Web Design');
...
<section class="webdesign-page-hero" data-section-theme="dark">
  ...
  <div class="webdesign-page-hero-content">
    <div class="webdesign-page-hero-text animate-fade-in">
      <span class="webdesign-page-hero-label"><?php echo wp_kses_post($hero_label); ?></span>
  ...
  <!-- Decorative Shapes -->
  <div class="webdesign-page-hero-shapes">
    <div class="webdesign-page-shape webdesign-page-shape-1"></div>
    <div class="webdesign-page-shape webdesign-page-shape-2"></div>
  </div>
</section>
    ...
    <div class="webdesign-page-stats-container">
        <?php foreach ($stats as $stat) : ?>
            <div class="webdesign-page-stat-item">
                <span class="webdesign-page-stat-number"><?php echo wp_kses_post(hd_wysiwyg_or_default($stat['number'] ?? '', '')); ?></span>
                <span class="webdesign-page-stat-label"><?php echo wp_kses_post(hd_wysiwyg_or_default($stat['label'] ?? '', '')); ?></span>
            </div>
        <?php endforeach; ?>
    </div>
</section>
...
// ACF Fields:
// - webdesign_what_is_heading_line1 (WYSIWYG)
// - webdesign_what_is_heading_line2 (WYSIWYG)
// - webdesign_what_is_content (WYSIWYG)
// - webdesign_what_is_image (Image)
// - webdesign_what_is_button (Link)
// ============================================
$what_is_heading_line1 = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_what_is_heading_line1') : '', 'What is');
$what_is_heading_line2 = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_what_is_heading_line2') : '', 'Web Design?');
...
// LONG CTA 1
// ACF Fields:
// - webdesign_long_cta1_label (WYSIWYG)
// - webdesign_long_cta1_heading_line1 (WYSIWYG)
// - webdesign_long_cta1_heading_line2 (WYSIWYG)
// - webdesign_long_cta1_text (WYSIWYG)
// - webdesign_long_cta1_features (Repeater)
//   - icon_svg (Textarea)
//   - title (WYSIWYG)
//   - description (WYSIWYG)
// - webdesign_long_cta1_primary_button (Link)
// - webdesign_long_cta1_secondary_button (Link)
// ============================================
$long_cta1_label = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_long_cta1_label') : '', 'READY TO STAND OUT?');
$long_cta1_heading_line1 = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_long_cta1_heading_line1') : '', 'Let\'s Create Your');
$long_cta1_heading_line2 = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_long_cta1_heading_line2') : '', 'Dream Website');
$long_cta1_text = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_long_cta1_text') : '', '');
...
<section class="webdesign-page-longcta webdesign-page-longcta-1" data-section-theme="light">
    <div class="webdesign-page-longcta-container">
        <div class="webdesign-page-longcta-content animate-fade-in">
            <span class="webdesign-page-longcta-label"><?php echo wp_kses_post($long_cta1_label); ?></span>
                ...
                <?php if ($long_cta1_features && is_array($long_cta1_features)) : ?>
                    <?php foreach ($long_cta1_features as $feature) : ?>
                        <div class="webdesign-page-longcta-feature">
                            <div class="webdesign-page-longcta-feature-icon"><?php echo !empty($feature['icon_svg']) ? hd_svg_output($feature['icon_svg']) : '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>'; ?></div>
                            <div class="webdesign-page-longcta-feature-text">
...
// SERVICES SECTION
// ACF Fields:
// - webdesign_services_label (WYSIWYG)
// - webdesign_services_heading (WYSIWYG)
// - webdesign_services_subheading (WYSIWYG)
// - webdesign_services (Repeater)
//   - title (WYSIWYG)
//   - description (WYSIWYG)
//   - icon_svg (Textarea)
// ============================================
$services_label = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_services_label') : '', 'What We Offer');
...
<section class="webdesign-page-services" id="services" data-section-theme="light">
    <div class="webdesign-page-services-container">
        <div class="webdesign-page-services-header">
            <span class="webdesign-page-services-label"><?php echo wp_kses_post($services_label); ?></span>
        ...
        <div class="webdesign-page-services-grid">
            <?php foreach (array_slice($services, 0, 4) as $service) : ?>
                <div class="webdesign-page-service-card">
                    <div class="webdesign-page-service-icon"><?php echo hd_svg_output($service['icon_svg'] ?? ''); ?></div>
...
// ACF Fields:
// - webdesign_why_heading_line1 (WYSIWYG)
// - webdesign_why_heading_line2 (WYSIWYG)
// - webdesign_why_content (WYSIWYG)
// - webdesign_why_image (Image)
// - webdesign_why_button (Link)
// ============================================
$why_heading_line1 = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_why_heading_line1') : '', 'Why Choose');
$why_heading_line2 = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_why_heading_line2') : '', 'Us?');
$why_content = $has_acf ? get_field('webdesign_why_content') : '';
$why_image = $has_acf ? get_field('webdesign_why_image') : null;
$why_button = $has_acf ? hd_link(get_field('webdesign_why_button')) : null;
$why_image_url = ($why_image && is_array($why_image) && !empty($why_image['url'])) ? esc_url($why_image['url']) : '';
if (!$why_button) $why_button = ['url' => '#contact', 'title' => 'Start Your Project', 'target' => '_self'];
?>
...
// ACF Fields:
// - webdesign_long_cta2_label (WYSIWYG)
// - webdesign_long_cta2_heading_line1 (WYSIWYG)
// - webdesign_long_cta2_heading_line2 (WYSIWYG)
// - webdesign_long_cta2_text (WYSIWYG)
// - webdesign_long_cta2_primary_button (Link)
// - webdesign_long_cta2_secondary_button (Link)
// ============================================
$long_cta2_label = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_long_cta2_label') : '', 'FREE CONSULTATION');
$long_cta2_heading_line1 = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_long_cta2_heading_line1') : '', 'Ready to Transform');
$long_cta2_heading_line2 = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_long_cta2_heading_line2') : '', 'Your Online Presence?');
$long_cta2_text = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_long_cta2_text') : '', 'Book a free consultation to discuss your project. We\'ll review your current website, understand your goals, and show you exactly how we can help you succeed online.');
...
<section class="webdesign-page-longcta webdesign-page-longcta-2" data-section-theme="light">
    <div class="webdesign-page-longcta-container">
        <div class="webdesign-page-longcta-content animate-fade-in">
            <span class="webdesign-page-longcta-label"><?php echo wp_kses_post($long_cta2_label); ?></span>
            <h2 class="webdesign-page-longcta-heading">
            ...
            <p class="webdesign-page-longcta-text"><?php echo wp_kses_post($long_cta2_text); ?></p>
            <div class="webdesign-page-longcta-buttons">
...
// PROCESS SECTION
// ACF Fields:
// - webdesign_process_label (WYSIWYG)
// - webdesign_process_heading (WYSIWYG)
// - webdesign_process_subheading (WYSIWYG)
// - webdesign_process_steps (Repeater)
//   - title (WYSIWYG)
//   - description (WYSIWYG)
// ============================================
$process_label = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_process_label') : '', 'How We Work');
...
<section class="webdesign-page-process" data-section-theme="light">
    <div class="webdesign-page-process-container">
        <div class="webdesign-page-process-header">
            <span class="webdesign-page-process-label"><?php echo wp_kses_post($process_label); ?></span>
        ...
        <div class="webdesign-page-process-timeline">
            <?php foreach ($process_steps as $index => $step) : ?>
                <div class="webdesign-page-process-step">
                    ...
                    <div class="webdesign-page-process-content">
...
// ACF Fields:
// - webdesign_ux_heading_line1 (WYSIWYG)
// - webdesign_ux_heading_line2 (WYSIWYG)
// - webdesign_ux_content (WYSIWYG)
// - webdesign_ux_image (Image)
// - webdesign_ux_button (Link)
// ============================================
$ux_heading_line1 = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_ux_heading_line1') : '', 'UX That');
$ux_heading_line2 = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_ux_heading_line2') : '', 'Converts');
...
<section class="webdesign-page-info webdesign-page-info-3" data-section-theme="light">
    <div class="webdesign-page-info-container">
        <h2 class="webdesign-page-info-heading animate-fade-in">
            <span class="black-text"><?php echo wp_kses_post($ux_heading_line1); ?></span><br>
            <span class="highlight-text-italic"><?php echo wp_kses_post($ux_heading_line2); ?></span>
        </h2>
        <div class="webdesign-page-info-content">
            <div class="webdesign-page-info-text animate-slide-left">
                <?php if ($ux_content) : ?>
...
// LONG CTA 3
// ACF Fields:
// - webdesign_long_cta3_label (WYSIWYG)
// - webdesign_long_cta3_heading_line1 (WYSIWYG)
// - webdesign_long_cta3_heading_line2 (WYSIWYG)
// - webdesign_long_cta3_text (WYSIWYG)
// - webdesign_long_cta3_features (Repeater)
//   - icon_svg (Textarea)
//   - title (WYSIWYG)
//   - description (WYSIWYG)
// - webdesign_long_cta3_primary_button (Link)
// - webdesign_long_cta3_secondary_button (Link)
// ============================================
$long_cta3_label = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_long_cta3_label') : '', 'WHAT\'S INCLUDED');
$long_cta3_heading_line1 = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_long_cta3_heading_line1') : '', 'Everything You Need');
$long_cta3_heading_line2 = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_long_cta3_heading_line2') : '', 'To Succeed Online');
$long_cta3_text = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_long_cta3_text') : '', '');
...
<section class="webdesign-page-longcta webdesign-page-longcta-3" data-section-theme="light">
    <div class="webdesign-page-longcta-container">
        <div class="webdesign-page-longcta-content animate-fade-in">
            <span class="webdesign-page-longcta-label"><?php echo wp_kses_post($long_cta3_label); ?></span>
            <h2 class="webdesign-page-longcta-heading">
...
// ACF Fields:
// - webdesign_results_label (WYSIWYG)
// - webdesign_results_heading (WYSIWYG)
// - webdesign_results_subheading (WYSIWYG)
// - webdesign_results (Repeater)
//   - industry (WYSIWYG)
//   - title (WYSIWYG)
//   - description (WYSIWYG)
...
//   - image (Image)
// ============================================
$results_label = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_results_label') : '', 'Our Work');
...
<section class="webdesign-page-results" data-section-theme="light">
    <div class="webdesign-page-results-container">
        <div class="webdesign-page-results-header">
            <span class="webdesign-page-results-label"><?php echo wp_kses_post($results_label); ?></span>
            ...
            ?>
                <div class="webdesign-page-result-card">
                    <div class="webdesign-page-result-image">
                        <?php if ($result_image) : ?>
                            <img src="<?php echo $result_image; ?>" alt="<?php echo esc_attr(strip_tags($result['title'] ?? 'Project')); ?>">
                        <?php else : ?>
                            <div class="webdesign-page-result-placeholder"><span><?php echo esc_html(substr(strip_tags($result['title'] ?? 'P'), 0, 1)); ?></span></div>
                        <?php endif; ?>
                    </div>
                    <div class="webdesign-page-result-content">
                        <span class="webdesign-page-result-industry"><?php echo wp_kses_post(hd_wysiwyg_or_default($result['industry'] ?? '', '')); ?></span>
                        ...
                        <div class="webdesign-page-result-metrics">
                            <div class="webdesign-page-result-metric">
                                <span class="webdesign-page-result-metric-value"><?php echo wp_kses_post(hd_wysiwyg_or_default($result['metric1_value'] ?? '', '')); ?></span>
                                <span class="webdesign-page-result-metric-label"><?php echo wp_kses_post(hd_wysiwyg_or_default($result['metric1_label'] ?? '', '')); ?></span>
                            </div>
                            <div class="webdesign-page-result-metric">
                                <span class="webdesign-page-result-metric-value"><?php echo wp_kses_post(hd_wysiwyg_or_default($result['metric2_value'] ?? '', '')); ?></span>
                                <span class="webdesign-page-result-metric-label"><?php echo wp_kses_post(hd_wysiwyg_or_default($result['metric2_label'] ?? '', '')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
// FAQ SECTION
// ACF Fields:
// - webdesign_faq_label (WYSIWYG)
// - webdesign_faq_heading (WYSIWYG)
// - webdesign_faqs (Repeater)
//   - question (WYSIWYG)
//   - answer (WYSIWYG)
// ============================================
$faq_label = hd_wysiwyg_or_default($has_acf ? get_field('webdesign_faq_label') : '', 'FAQ');
...
<section class="webdesign-page-faq" data-section-theme="light">
    <div class="webdesign-page-faq-container">
        <div class="webdesign-page-faq-header">
            <span class="webdesign-page-faq-label"><?php echo wp_kses_post($faq_label); ?></span>
        ...
        <div class="webdesign-page-faq-list">
            <?php foreach ($faqs as $index => $faq) : ?>
                <div class="webdesign-page-faq-item" data-faq-index="<?php echo $index; ?>">
                    <button class="webdesign-page-faq-question" aria-expanded="false">
                    ...
                    <div class="webdesign-page-faq-answer"><p><?php echo wp_kses_post(hd_wysiwyg_or_default($faq['answer'] ?? '', '')); ?></p></div>
                </div>
            <?php endforeach; ?>
        </div>
    </div>

...
// HERO
$hero_label = $has_acf ? (get_field('seo_hero_label') ?: 'Search Engine Optimisation') : 'Search Engine Optimisation';
...
<!-- HERO - Same style as About Us page -->
<section class="seo-page-hero" data-section-theme="dark">
  ...
  <div class="seo-page-hero-content">
    <div class="seo-page-hero-text animate-fade-in">
      <span class="seo-page-hero-label"><?php echo esc_html($hero_label); ?></span>
  ...
  <!-- Decorative Shapes - Same as other pages -->
    ...
    <div class="seo-page-stats-container">
        <?php foreach ($stats as $stat) : ?>
            <div class="seo-page-stat-item">
                <span class="seo-page-stat-number"><?php echo esc_html($stat['number'] ?? ''); ?></span>
                <span class="seo-page-stat-label"><?php echo esc_html($stat['label'] ?? ''); ?></span>
            </div>
        <?php endforeach; ?>
    </div>
</section>
...
$what_is_heading_line1 = $has_acf ? get_field('seo_what_is_heading_line1') : '';
$what_is_heading_line2 = $has_acf ? get_field('seo_what_is_heading_line2') : '';
...
<section class="seo-page-info seo-page-info-1" data-section-theme="light">
    <div class="seo-page-info-container">
        <h2 class="seo-page-info-heading animate-fade-in">
            ...
            <span class="highlight-text-italic"><?php echo $what_is_heading_line2 ? esc_html($what_is_heading_line2) : 'SEO?'; ?></span>
        </h2>
...
<?php
// LONG CTA 1
$long_cta1_label = $has_acf ? get_field('seo_long_cta1_label') : '';
$long_cta1_heading_line1 = $has_acf ? get_field('seo_long_cta1_heading_line1') : '';
$long_cta1_heading_line2 = $has_acf ? get_field('seo_long_cta1_heading_line2') : '';
$long_cta1_text = $has_acf ? get_field('seo_long_cta1_text') : '';
...
<section class="seo-page-longcta seo-page-longcta-1" data-section-theme="light">
    <div class="seo-page-longcta-container">
        <div class="seo-page-longcta-content animate-fade-in">
            <span class="seo-page-longcta-label"><?php echo $long_cta1_label ? esc_html($long_cta1_label) : 'READY TO RANK?'; ?></span>
            <h2 class="seo-page-longcta-heading">
                <span class="black-text"><?php echo $long_cta1_heading_line1 ? esc_html($long_cta1_heading_line1) : 'Let\'s Get You'; ?></span><br>
                <span class="highlight-text-italic"><?php echo $long_cta1_heading_line2 ? esc_html($long_cta1_heading_line2) : 'Found Online'; ?></span>
            </h2>
                ...
                <?php if ($long_cta1_features && is_array($long_cta1_features)) : ?>
                    <?php foreach ($long_cta1_features as $feature) : ?>
                        <div class="seo-page-longcta-feature">
                            <div class="seo-page-longcta-feature-icon"><?php echo !empty($feature['icon_svg']) ? wp_kses_post($feature['icon_svg']) : '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>'; ?></div>
                            <div class="seo-page-longcta-feature-text"><h4><?php echo esc_html($feature['title'] ?? ''); ?></h4><p><?php echo esc_html($feature['description'] ?? ''); ?></p></div>
                        </div>
                    <?php endforeach; ?>
                <?php else : ?>
...
<?php
// SERVICES
$services_label = $has_acf ? (get_field('seo_services_label') ?: 'What We Offer') : 'What We Offer';
...
<section class="seo-page-services" id="services" data-section-theme="light">
    <div class="seo-page-services-container">
        <div class="seo-page-services-header">
            <span class="seo-page-services-label"><?php echo esc_html($services_label); ?></span>
        ...
        <div class="seo-page-services-grid">
            <?php foreach (array_slice($services, 0, 4) as $service) : ?>
                <div class="seo-page-service-card">
                    <div class="seo-page-service-icon"><?php echo wp_kses_post($service['icon_svg'] ?? ''); ?></div>
...
$why_heading_line1 = $has_acf ? get_field('seo_why_different_heading_line1') : '';
$why_heading_line2 = $has_acf ? get_field('seo_why_different_heading_line2') : '';
...
<section class="seo-page-info seo-page-info-2" data-section-theme="light">
    <div class="seo-page-info-container">
        <h2 class="seo-page-info-heading animate-fade-in">
            <span class="black-text"><?php echo $why_heading_line1 ? esc_html($why_heading_line1) : 'Why Are We'; ?></span><br>
...
$long_cta2_label = $has_acf ? get_field('seo_long_cta2_label') : '';
$long_cta2_heading_line1 = $has_acf ? get_field('seo_long_cta2_heading_line1') : '';
$long_cta2_heading_line2 = $has_acf ? get_field('seo_long_cta2_heading_line2') : '';
$long_cta2_text = $has_acf ? get_field('seo_long_cta2_text') : '';
...
<section class="seo-page-longcta seo-page-longcta-2" data-section-theme="light">
    <div class="seo-page-longcta-container">
        <div class="seo-page-longcta-content animate-fade-in">
            <span class="seo-page-longcta-label"><?php echo $long_cta2_label ? esc_html($long_cta2_label) : 'FREE SEO AUDIT'; ?></span>
            <h2 class="seo-page-longcta-heading">
            ...
            <p class="seo-page-longcta-text"><?php echo $long_cta2_text ? wp_kses_post($long_cta2_text) : 'Get a comprehensive analysis of your website\'s SEO performance. We\'ll identify opportunities, uncover issues, and show you exactly how to improve your search visibility.'; ?></p>
            <div class="seo-page-longcta-buttons">
...
<?php
// PROCESS
$process_label = $has_acf ? (get_field('seo_process_label') ?: 'How We Work') : 'How We Work';
...
<section class="seo-page-process" data-section-theme="light">
    <div class="seo-page-process-container">
        <div class="seo-page-process-header">
            <span class="seo-page-process-label"><?php echo esc_html($process_label); ?></span>
        ...
        <div class="seo-page-process-timeline">
            <?php foreach ($process_steps as $index => $step) : ?>
                <div class="seo-page-process-step">
                    ...
                    <div class="seo-page-process-content"><h3><?php echo esc_html($step['title'] ?? ''); ?></h3><p><?php echo esc_html($step['description'] ?? ''); ?></p></div>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
...
$audits_heading_line1 = $has_acf ? get_field('seo_audits_heading_line1') : '';
$audits_heading_line2 = $has_acf ? get_field('seo_audits_heading_line2') : '';
...
<section class="seo-page-info seo-page-info-3" data-section-theme="light">
    <div class="seo-page-info-container">
        <h2 class="seo-page-info-heading animate-fade-in">
            <span class="black-text"><?php echo $audits_heading_line1 ? esc_html($audits_heading_line1) : 'SEO'; ?></span><br>
            <span class="highlight-text-italic"><?php echo $audits_heading_line2 ? esc_html($audits_heading_line2) : 'Audits'; ?></span>
        </h2>
        <div class="seo-page-info-content">
            <div class="seo-page-info-text animate-slide-left">
...
<?php
// LONG CTA 3
$long_cta3_label = $has_acf ? get_field('seo_long_cta3_label') : '';
$long_cta3_heading_line1 = $has_acf ? get_field('seo_long_cta3_heading_line1') : '';
$long_cta3_heading_line2 = $has_acf ? get_field('seo_long_cta3_heading_line2') : '';
$long_cta3_text = $has_acf ? get_field('seo_long_cta3_text') : '';
...
<section class="seo-page-longcta seo-page-longcta-3" data-section-theme="light">
    <div class="seo-page-longcta-container">
        <div class="seo-page-longcta-content animate-fade-in">
            <span class="seo-page-longcta-label"><?php echo $long_cta3_label ? esc_html($long_cta3_label) : 'PROVEN RESULTS'; ?></span>
            <h2 class="seo-page-longcta-heading">
                <span class="black-text"><?php echo $long_cta3_heading_line1 ? esc_html($long_cta3_heading_line1) : 'Ready to Dominate'; ?></span><br>
                <span class="highlight-text-italic"><?php echo $long_cta3_heading_line2 ? esc_html($long_cta3_heading_line2) : 'Search Results?'; ?></span>
            </h2>
...
<?php
// RESULTS
$results_label = $has_acf ? (get_field('seo_results_label') ?: 'Case Studies') : 'Case Studies';
...
<section class="seo-page-results" data-section-theme="light">
    <div class="seo-page-results-container">
        <div class="seo-page-results-header">
            <span class="seo-page-results-label"><?php echo esc_html($results_label); ?></span>
            ...
            ?>
                <div class="seo-page-result-card">
                    <div class="seo-page-result-image">
                        ...
                        <?php else : ?>
                            <div class="seo-page-result-placeholder"><span><?php echo esc_html(substr($result['title'] ?? 'C', 0, 1)); ?></span></div>
                        <?php endif; ?>
                    </div>
                    <div class="seo-page-result-content">
                        <span class="seo-page-result-industry"><?php echo esc_html($result['industry'] ?? ''); ?></span>
                        <h3><?php echo esc_html($result['title'] ?? ''); ?></h3>
                        <p><?php echo esc_html($result['description'] ?? ''); ?></p>
                        <div class="seo-page-result-metrics">
                            <div class="seo-page-result-metric"><span class="seo-page-result-metric-value"><?php echo esc_html($result['metric1_value'] ?? ''); ?></span><span class="seo-page-result-metric-label"><?php echo esc_html($result['metric1_label'] ?? ''); ?></span></div>
                            <div class="seo-page-result-metric"><span class="seo-page-result-metric-value"><?php echo esc_html($result['metric2_value'] ?? ''); ?></span><span class="seo-page-result-metric-label"><?php echo esc_html($result['metric2_label'] ?? ''); ?></span></div>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
...
<?php
// FAQ
$faq_label = $has_acf ? (get_field('seo_faq_label') ?: 'FAQ') : 'FAQ';
...
<section class="seo-page-faq" data-section-theme="light">
    <div class="seo-page-faq-container">
        <div class="seo-page-faq-header">
            <span class="seo-page-faq-label"><?php echo esc_html($faq_label); ?></span>
        ...
        <div class="seo-page-faq-list">
            <?php foreach ($faqs as $index => $faq) : ?>
                <div class="seo-page-faq-item" data-faq-index="<?php echo $index; ?>">
                    <button class="seo-page-faq-question" aria-expanded="false"><span><?php echo esc_html($faq['question'] ?? ''); ?></span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg></button>
                    <div class="seo-page-faq-answer"><p><?php echo wp_kses_post($faq['answer'] ?? ''); ?></p></div>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
